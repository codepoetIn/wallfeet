 ...
 *
 * @version $Id: yii.php,v 1.1.1.1 2012-01-04 21:08:27 karthick Exp $
 */
...
return array (
  ...
  'Active record "{class}" has an invalid configuration for relation "{relation}". It must specify the relation type, the related active record class and the foreign key.' => 'Active record "{class}" има невалидна конфигурация за релацията "{relation}". Тя трябва да оказва типа на релацията, active record за който се откася и ключа',
  ...
  'Alias "{alias}" is invalid. Make sure it points to an existing directory or file.' => 'Псевдонима "{alias}" не съществува. Провете дали води до съществуваща директория или файл.',
  ...
  'CDbHttpSession.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'DbHttpSession.connectionID "{id}" е невалидна. Моля, уверете се че сочи към ID на CDbConnection application компоненета.',
  ...
  'CFilterChain can only take objects implementing the IFilter interface.' => 'CFilterChain може да взима единствено обенти, имплементиращи интерфейса IFilter.',
  ...
  'CMemCache server configuration must be an array.' => 'Сърварната конфигурация на CMemCache трябва да бъде масив.',
  'CMemCache server configuration must have "host" value.' => 'Сърварната конфигурация на CMemCache трябва да има стойност "host".',
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yii::beginProfile() and Yii::endProfile() be properly nested.' => 'CProfileLogRoute намери несъответсващ блок от код "{token}". Моля, проверете обръщането към Yii::beginProfile() и Yii::endProfile().',
  ...
  'CSecurityManager requires PHP mcrypt extension to be loaded in order to use data encryption feature.' => 'CSecurityManager изисква наличието на PHP допълнението mcrypt, за да може да изпозлвате функциите за криптиране.',
  ...
  'Error: Table "{table}" has a composite primary key which is not supported by crud command.' => 'Грешка: Таблицата "{table}" има сложен първичен ключ, който не се поддържа от crud командадата.',
  ...
  'Missing the temporary folder to store the uploaded file "{file}".' => 'Временната папка, за съхраниение на качения файл "{file}" липсва.',
  'Next &gt;' => 'Напред',
  ...
  'The pattern for AM/PM marker must be "a".' => 'Шаблона за AM/PM мармера трябва да е "a".',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key. The format of the foreign key must be "joinTable(fk1,fk2,...)".' => 'Релацията "{relation}" в active record класа "{class}" е с невалидно зададен клюя. Формата на ключа трябва да е "joinTable(fk1,fk2,...)"',
  ...
  '{class} does not support fetching all table names.' => '{class} не поддържа fetching на виски имена на таблици.',
  ...
  '{controller} has an extra endWidget({id}) call in its view.' => '{controller} има допълнителен endWidget({id}) извикан в негото view.',
