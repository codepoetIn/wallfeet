...
return array (
  ...
  'Active record class "{class}" does not have a scope named "{scope}".' => 'Active Record-klassen "{class}" har inte det namngivna omfånget (named scope) "{scope}".',
  ...
  'Failed to set unsafe attribute "{attribute}".' => 'Misslyckades att tilldela det ej säkra attributet "{attribute}".',
  ...
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => 'Kan inte importera "{alias}". Kontrollera att serverkonfigurationen tillåter dig att ändra PHP:s include_path.',
  ...
  '{class} does not have a method named "{name}".' => '{class} har inte en metod med namnet "{name}".',
