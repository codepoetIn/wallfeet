...
return array (
  ...
  'CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbCacheDependency.connectionID "{id}"は不正です。CDbConnectionアプリケーションコンポーネントのIDを指しているか確認してください。',
  ...
  'CDbConnection failed to open the DB connection.' => 'CDbConnectionはデータベース接続をオープンできませんでした。',
  'CDbTestFixture.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbTestFixture.connectionID "{id}"は不正です。CDbConnectionアプリケーションコンポーネントのIDを指しているか確認してください。',
  ...
  'CWinCache user cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCacheユーザキャッシュがディスエーブルです。php.ini中のwincache.ucenabledをOnに設定してください。',
  'Dropping DB column is not supported by SQLite.' => 'SQLiteではデータベースカラムを削除することはできません。',
  'Dropping a foreign key constraint is not supported by SQLite.' => 'SQLiteではフォーリンキー制約を削除することはできません。',
  'Extension path "{path}" does not exist.' => 'イクステンションパス"{path}"は存在しません。',
  'Failed to initialize the mcrypt module.' => 'mcryptモジュールは初期化できませんでした。',
  'Failed to set unsafe attribute "{attribute}".' => '安全でないアトリビュート"{attribute}"をセットできませんでした。',
  'Filter "{filter}" is invalid. Controller "{class}" does not have the filter method "filter{filter}".' => '"{filter}"というフィルタは不正です。コントローラ"{class}"にはそのようなフィルタメソッドは存在しません。',
  'GD and FreeType PHP extensions are required.' => 'GDとFreeTypeのPHP拡張が必要です。',
  'Invalid operator "{operator}".' => 'オペレータ"{operator}"が不正です。',
  ...
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE", "EEEEE", "e", "ee", "eee", "eeee", "eeeee", "c", "cccc" or "ccccc".' => '曜日のパターンは"E"か"EE"か"EEE"か"EEEE"か"EEEEE"か"e"か"ee"か"eee"か"eeee"か"eeeee"か"c"か"cccc"か"ccccc"です。',
  'The pattern for month must be "M", "MM", "MMM", "MMMM", "L", "LL", "LLL" or "LLLL".' => '月のパターンは"M"か"MM"か"MMM""MMMM"か"L"か"LL"か"LLL"か"LLLL"です。',
  'The requested view "{name}" was not found.' => '要求されたビュー"{name}"は見付かりません。',
  'Unable to find "{column}" in table "{table}".' => 'テーブル"{table}"中にカラム"{column}"が見付かりません。',
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => '"{alias}"をインポートできません。PHPインクルードパスを変更可能か、サーバ構成をチェックしてください。',
  'Unknown operator "{operator}".' => '"{operator}"は不明なオペレータです。',
  'Unknown type "{type}".' => '”typer}”不明な型です。',
  'Your request is invalid.' => '不正なリクエストです。',
  '{attribute} cannot accept more than {limit} files.' => '{attribute}は{limit}以上のファイルを受け取れません。',
  ...
  '{attribute} must be greater than "{compareValue}".' => '{attribute}は"{compareValue}"より大である必要があります。',
  '{attribute} must be greater than or equal to "{compareValue}".' => '{attribute}は"{compareValue}"以上である必要があります。',
  '{attribute} must be less than "{compareValue}".' => '{attribute}は"{compareValue}"より小である必要があります。',
