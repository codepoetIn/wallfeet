...
return array (
  ...
  'The active record cannot be deleted because it is new.' => 'L\'active record non può essere eliminato perché è nuovo.',
  'The active record cannot be inserted to database because it is not new.' => 'L\'active record non può essere inserito nel DB perché non è nuovo.',
  'The active record cannot be updated because it is new.' => 'L\'active record non può essere aggiornato perché è nuovo.',
  ...
  'The pattern for 12 hour format must be "h" or "hh".' => 'Il formato per le 12 ore deve essere "h" ó "hh".',
  'The pattern for 24 hour format must be "H" or "HH".' => 'Il formato per le 24 ore deve essere "H" ó "HH".',
  ...
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE" or "EEEEE".' => 'Il formato per il giorno della settimana deve essere "E", "EE", "EEE", "EEEE" ó "EEEEE".',
  'The pattern for era must be "G", "GG", "GGG", "GGGG" or "GGGGG".' => 'Il formato per l\'era deve essere "G", "GG", "GGG", "GGGG" ó "GGGGG".',
  'The pattern for hour in AM/PM must be "K" or "KK".' => 'Il formato per l\'ora in AM/PM deve essere "K" ó "KK".',
  'The pattern for hour in day must be "k" or "kk".' => 'Il formato per l\'ore nel giorno deve essere "k" ó "kk".',
  'The pattern for minutes must be "m" or "mm".' => 'Il formato per i minuti deve essere "m" ó "mm".',
  'The pattern for month must be "M", "MM", "MMM", or "MMMM".' => 'Il formato per il mese deve essere "M", "MM", "MMM" o "MMMM".',
  'The pattern for seconds must be "s" or "ss".' => 'Il formato per i secondi deve essere "s" ó "ss".',
  'The pattern for time zone must be "z" or "v".' => 'Il formato per la timezone deve essere "z" ó "v".',
