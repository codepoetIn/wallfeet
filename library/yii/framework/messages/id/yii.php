...
return array (
  ...
  'Active record class "{class}" does not have a scope named "{scope}".' => 'Kelas active record "{class}" tidak memliki scope bernama "{scope}".',
  ...
  'Failed to set unsafe attribute "{attribute}".' => 'Gagal set attribute unsafe "{attribute}"',
  ...
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => 'Tidak bisa import "{alias}". Silahkan cek konfigurasi server anda untuk memastikan anda diizinkan untuk mengubah include_path PHP.',
  ...
  'Your request is not valid.' => 'Request Anda tidak valid.',
  ...
  '{class} does not have a method named "{name}".' => '{class} tidak memiliki method bernama "{name}".',
