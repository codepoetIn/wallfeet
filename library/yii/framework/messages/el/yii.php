...
return array (
  ...
  'Alias "{alias}" is invalid. Make sure it points to an existing PHP file.' => 'Το ψευδώνυμο "{alias}" δεν είναι έγκυρο. Βεβαιωθείτε ότι δείχνει σε υπάρχον αρχείο PHP.',
  ...
  'CDbConnection failed to open the DB connection.' => 'Το CDbConnection απέτυχε να ανοίξει τη σύνδεση για τη βάση δεδομένων.',
