...
return array (
  ...
  'Active record class "{class}" does not have a scope named "{scope}".' => 'Klasa rekordu aktywnego "{class}" nie posiada nazwanego zbioru (ang. scope) "{scope}"',
  ...
  'CDbAuthManager.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'Identyfikator CDbAuthManager.connectionID "{id}" jest niewłaściwy. Upewnij się, że odnosi się on do ID komponentu aplikacji CDbConnection.',
  'CDbCache.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'Identyfikator CDbCache.connectionID "{id}" jest nieprawidłowy. Upewnij się, że odnosi się on do ID komponentu aplikacji CDbConnection.',
  'CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'DbCacheDependency.connectionID "{id}" jest nierpawidłowy. Upewnij się, że wskazuje on na ID komponentu aplikacji CDbConnection.',
  ...
  'Failed to set unsafe attribute "{attribute}".' => 'Ustawianie niebezpiecznego (ang. unsafe) atrybutu "{attribute}" nie powiodło się.',
  ...
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => 'Nie można zaimportować "{alias}". Sprawdź konfigurację swojego serwera aby upewnić się, że możesz zmieniać PHP include_path.',
  ...
  'Unable to resolve the request "{route}".' => 'Nie można rozszyfrować żądania "{route}".',
  'Unable to write file "{file}".' => 'Nie można zpisać do pliku "{file}".',
  ...
  '{attribute} must be less than or equal to "{compareValue}".' => 'Atrybut {attribute} musi być mniejszy równy "{compareValue}".',
  ...
  '{attribute} must be {value}.' => 'Atrybut {attribute} musi posiadać wartość {value}.',
  ...
  '{class} does not have a method named "{name}".' => 'Klasa {class} nie posiada metody "{name}".',
