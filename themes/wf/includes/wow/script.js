...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:20*100,outWidth:940,outHeight:200,width:940,height:200,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,controls:true});