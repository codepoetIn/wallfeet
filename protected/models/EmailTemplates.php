...
class EmailTemplates extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, from_email, from_name, subject, body_html, body_plain, created_by', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'createdBy' => array(self::BELONGS_TO, 'UserCredentials', 'created_by'),
			'updatedBy' => array(self::BELONGS_TO, 'UserCredentials', 'updated_by'),
		);
	}
