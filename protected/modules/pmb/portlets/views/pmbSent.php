<?php 
	if($messages){
    	...
    	<div id="property_search_results">
        	<h1 class="property_search_results_top">'.count($messages).' Message Found <span class="right new"></span> </h1>';
		echo '<div class="messages">';
		echo '<div class="mes_header">';
		echo '<span class="from">Sent To</span>';
		...
		foreach ($messages as $message){
			$from = "";
			if(isset($first_name[$message->to_user_id]))
				$from = $first_name[$message->to_user_id]." ".$last_name[$message->to_user_id];
