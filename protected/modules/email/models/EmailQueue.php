...
class EmailQueue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('subject, body_html, body_plain', 'required'),
			array('attempts, created_by, updated_by', 'numerical', 'integerOnly'=>true),
			...
			array('id, from_email, from_name, subject, body_html, body_plain, attempts, message, created_by, updated_time, created_time, updated_by', 'safe', 'on'=>'search'),
		);
	}
