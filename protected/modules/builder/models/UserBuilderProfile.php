...
/**
 * This is the model class for table "user_builder_profile".
 *
 * The followings are the available columns in table 'user_builder_profile':
 * @property integer $id
 ...
 */
class UserBuilderProfile extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return UserBuilderProfile the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('address_line2,telephone,email,website,image, updated_time, created_time', 'safe'),
			array('email', 'email'),
