...
<div id="menu-part">
  <div  id="menu">
    <ul>
      ...
      <li id="menubox_search"><a  class="drop">Search</a>
        <!-- Begin Home Item -->
...
<input type="submit" class="btn-submit-s" onclick="return fnpropertycityid()" value="" name="search">
              ...
              <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <label style="padding-right:3px;">City</label>
                   <?php echo $form->dropdownList($modelCity,'city',
                   $cityList,array('class'=>'select_box','id'=>'GeoCity_city_people','empty'=>'All'))?>
                   </br>
					<center><input type="submit" class="btn-submit-s" onclick="return fnpeoplecityid()" value="" name="submit"></center>
					<?php $this->endWidget(); ?>
              </div>
            </div>
          </div>
      ...
      <!-- End Home Item -->
      <li id="menubox_postp"><a  class="drop">Post Property</a>
      ...
      <li id="menubox_req"><a  class="drop">Post Requirement</a>
        <div class="dropdown_2columns">
      ...
      <li id="menubox_sp"><a  class="drop">WF Specialists</a>
        ...
        <div class="dropdown_2columns">
          ...
          <div class="col_1">
              ...
              <ul class="tabNavigation6 left">
                <li><a href="#wfs-one" class="selected">WF Specialists</a></li><!--
      ...
      <li id="menubox_jackpot"><a class="drop">Jackpot Investments</a>
      	<div class="dropdown_2columns">
      	                      <?php $form=$this->beginWidget('CActiveForm', array(
				'id'=>'agent-search-form',
              	'action'=>'/search/property',
         	...
         	<div class="col_1">
              ...
              <ul class="tabNavigation7 left">
                ...
                <!--<li><a href="#jp-two">Top Investments</a></li>
              --></ul>
              ...
              <div id="jp-two" class="left">
              	<div class="specialists-photos">
                    <ul>
                      <li><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/user.jpg" alt="" class="left" /></a></li>
                      <li><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/user.jpg" alt="" class="left" /></a></li>
                      <li><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/user.jpg" alt="" class="left" /></a></li>
                      <li><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/user.jpg" alt="" class="left" /></a></li>
                      <li><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/user.jpg" alt="" class="left" /></a></li>
	  ...
	  <li id="menubox_instant"><a class="drop">Instant Gratifications</a>
      ...
      <li id="menubox_new"><a  class="drop">New Launches</a>
      	 <div class="dropdown_8columns" style="padding-bottom: 10px;width: 358px;">
      	                       <?php $form=$this->beginWidget('CActiveForm', array(
				'id'=>'agent-search-form',
              	'action'=>'/search/property',
				'enableAjaxValidation'=>false,
      ...
      <li class="mar-rgt0"><a href="/Price" class="drop">Advertise</a>
        <div class="dropdown_3columns" style="width:170px;">
          <p>Take your brand to the masses. Promote your listings in style. </p>
        </div>
      </li>
      <?php $this->endCache(); } ?>
      ...
      <li><a href="<?php echo Yii::app()->createUrl('/dashboard');?>" class="drop">My Account</a>
        <div class="dropdown_3columns_account" style="width:148px;">
          <p>Control your account specific information here.</p>
          <div class="col_3"> 
 ...
 <script type="text/javascript">
 	 function validateMinMax(minid,maxid)
	 {
	 	...
	 	if(min==1)
	 	{
	 		alert("Your not allowed to enter maximum value");
