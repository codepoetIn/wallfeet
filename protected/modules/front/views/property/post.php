...
<ul>
	...
	<?php echo $form->dropDownList($model,'property_type_id',CHtml::listData(PropertyTypes::model()->findAll(),'id','property_type','category.category'),array('empty'=>'Select','class'=>'slctbox','onChange'=>'fnPropertyTypes(this)','id'=>'property_type'));	?>
	</li>
...
<ul>
	...
	array('empty'=>'Select','id'=>'geo_city','class'=>'select-box-signup',
		 'ajax' => array(
                        'type'=>'POST',
                        'url'=>CController::createUrl('/location/map/render/name/Property/request/Property/modelname/Property'),  
...
<ul id="property-hidden">
	...
	<?php echo $form->dropdownList($model,'locality_id',CHtml::listData(GeoLocality::model()->findAll('city_id=:city_id',array(':city_id'=>$model->city_id)),'id','locality'),array('empty'=>'Select','class'=>'slctbox'));?>
	</div>
	</li>
...
<ul>
	...
	<?php
	$amenitiesHouse='';
	if(isset($_POST['PropertyAmenitiesHouse'])) 
	$amenitiesHouse=$_POST['PropertyAmenitiesHouse'];
	echo CHtml::checkBoxList('PropertyAmenitiesHouse',$amenitiesHouse,CHtml::listData(CategoryAmenities::model()->findAll('amenity_type=:amenityType',array(':amenityType'=>'0')),'id','amenity'));
...
<ul>
	...
	$amenitiesExternal='';
	if(isset($_POST['PropertyAmenitiesExternal'])) 
	$amenitiesExternal=$_POST['PropertyAmenitiesExternal'];
	echo CHtml::checkBoxList('PropertyAmenitiesExternal',$amenitiesExternal,CHtml::listData(CategoryAmenities::model()->findAll('amenity_type=:amenityType',array(':amenityType'=>'1')),'id','amenity'));
	?></div>
	</li>
	<li class="error_message"><?php echo $form->error($propertyAmenities,'amenity_id'); ?></li>
</ul>
...
<fieldset><legend>Additional Details</legend>
<input type="checkbox" onClick="additionalDetails(this)" id="additional_details" name="additional_details" <?php if(isset($_POST['additional_details'])) echo 'checked=checked';?>> Click for Additional Details
</fieldset>
...
var ptype1=document.getElementById('property_type');
fnPropertyTypes(ptype1);
