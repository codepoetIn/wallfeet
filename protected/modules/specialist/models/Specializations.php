...
class Specializations extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, specialist, updated_time, updated_by, created_time, created_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'userSpecialistProfiles' => array(self::HAS_MANY, 'UserSpecialistProfile', 'specialist_type_id'),
			'userSpecialistProjects' => array(self::HAS_MANY, 'UserSpecialistProjects', 'specialist_type_id'),
			'userSpecialistTypes' => array(self::HAS_MANY, 'UserSpecialistType', 'specialist_type_id'),
		);
	}
