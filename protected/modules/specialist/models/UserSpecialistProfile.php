 ...
 * @property UserSpecialistRating[] $userSpecialistRatings
 */
class UserSpecialistProfile extends ResourceActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, company_name, contact_person_name, company_description, address_line1, country_id, state_id, city_id, mobile', 'required'),
			array('user_id, country_id, state_id, city_id', 'numerical', 'integerOnly'=>true),
			array('updated_by, created_by', 'length', 'max'=>10),
			array('address_line2, telephone, email, image, updated_time, created_time', 'safe'),
			array('email', 'email'),
			...
			array('id, user_id, company_name, contact_person_name, company_description, address_line1, address_line2, country_id, state_id, city_id, mobile, telephone, email, image, updated_time, updated_by, created_time, created_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'userSpecialistRatings' => array(self::HAS_MANY, 'UserSpecialistRating', 'specialist_id'),
		);
	}
