...
<h1>Manage Jackpot Properties</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'property-grid',
	'dataProvider'=>$model->search("jackpot"),
	'filter'=>$model,
	'columns'=>array(
		'id',
		...
		'template'=>'{view} {update} {delete} {approve}',
    		'buttons'=>array(
    					'approve' => array(
            					...
            					'url'=>'Yii::app()->createUrl("store/property/jackpot/id/$data->id")',
		 						'visible'=>'$data->jackpot_investment==2',
        				),
				),
