<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('warnings')); ?>:</b>
	<?php echo CHtml::encode($data->warnings); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('registered_ip')); ?>:</b>
	<?php echo CHtml::encode($data->registered_ip); ?>
	<br />
