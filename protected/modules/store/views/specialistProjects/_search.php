...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'specialist_type_id'); ?>
		<?php echo $form->textField($model,'specialist_type_id'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'duration',array('rows'=>6, 'cols'=>50)); ?>
	</div>
