...
<head>
	...
	<link rel="shortcut icon" href="<?php echo Yii::app()->theme->baseUrl; ?>/images/favicon.ico" type="image/x-icon"></link>
	...
	<script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl; ?>/js/basic.js"></script> <!-- javascript which we write -->
</head>
<body>
...
<div id="wrapper">
  <div class="header">
    <h1 class="left" style="margin-top:10px;"><a href="<?php echo Yii::app()->createAbsoluteUrl('/');?>"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.png" alt="" /></a></h1>
